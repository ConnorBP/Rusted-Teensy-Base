//our custom implementation for accessing GPIO ports
...
impl Port {
    ...
    //responsible for switching a single pin into GPIO (or any other) mode
    //the unsafety is because calling it for a pin that you do not own could cause a race condition.
